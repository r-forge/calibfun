...
preDf = preDf[,!(names(preDf) %in% c("V2","V5","Q36","Q37","Q35"))]
names(preDf)
#####################################################################################
...
oldPreNames = names(preDf)[-c(1:3)]
names(preDf)[-c(1:3)] = newPreNames
...
preCharVarNames  = c("V1","V3","V4","Q002","Q005","Q014")
...
names(preDf)[1:3] =as.character(predesc[1:3])
head(preDf)
